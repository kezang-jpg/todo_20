...
public class ActivityInputOutputTest {
    ...
    public void activityLaunch(){
        ...
        onView(withId(R.id.reply_btn)).perform(click());
    ...
    public void testInputOutput(){
        onView(withId(R.id.sendEditText)).perform(typeText("This is a text"));
        onView(withId(R.id.send_btn)).perform(click());
        onView(withId(R.id.replyEditText)).perform(typeText("This is a text"));
        onView(withId(R.id.reply_btn)).perform(click());
    }
    @Test
